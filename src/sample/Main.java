...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) throws Exception{
        primaryStage.setTitle("ElementZ");
    ...
    public void detectCol(int n) {
        for(int i=0; i<8; i++) {
            for(int j=0; j<(8-n+1); j++) {
                ...
                int k = j;
                while(k<j+n && colOk) {
                    if (matrix[k][i] != first && matrix[k][i]!=0) colOk = false;
                    k++;
                }
                if (colOk) {
    ...
    //--------------------------------------------------------------------------
    // Aprés une permutation du joueur :
    // 1. on vÃ©rifie toutes les familles créées
    ...
    //--------------------------------------------------------------------------
    // Jouer :
    // Apeés une permutation, on vérifie si une famille est crée ou non
